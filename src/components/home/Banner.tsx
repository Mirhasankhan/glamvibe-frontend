  ...
  return (
    ...
    >
      <div className="bg-black bg-opacity-60 flex flex-col items-center justify-center w-full h-full">
        ...
        <h1 className="text-6xl font-medium py-3 text-white">
          SPA AND BEAUTY SALON
        </h1>
        <p className="text-xl py-2 text-white">
          Give yourself a moment to relax, Find a minute to rejuvanate your
          body.
        </p>
        <Link href="/book-appointment">          
          <button className="border border-primary py-2 px-6 mt-4 rounded-md text-primary hover:bg-primary hover:text-white font-medium">
            Get An Appointment
          </button>
        </Link>
